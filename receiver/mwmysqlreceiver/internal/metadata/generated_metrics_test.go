...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordMysqlConnectionActiveCountDataPoint(ts, 1)
			...
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordMysqlTotalRowsDataPoint(ts, 1, "dbname-val")
			...
			for _, mi := range allMetricsList {
				...
				case "mysql.connection.active.count":
					assert.False(t, validatedMetrics["mysql.connection.active.count"], "Found a duplicate in the metrics slice: mysql.connection.active.count")
					validatedMetrics["mysql.connection.active.count"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The numner of active connections to the MySQL server", mi.Description())
					assert.Equal(t, "1", mi.Unit())
				...
				case "mysql.innodb.rows_deleted":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "Rate at which rows are being deleted in InnoDB.", mi.Description())
				...
				case "mysql.innodb.rows_inserted":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "Rate at which rows are being inserted in InnoDB.", mi.Description())
					assert.Equal(t, "{row}/s", mi.Unit())
					assert.False(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.innodb.rows_read":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "Rate at which rows are being read in InnoDB.", mi.Description())
					assert.Equal(t, "{row}/s", mi.Unit())
					assert.False(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.innodb.rows_updated":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "Rate at which rows are being updated in InnoDB.", mi.Description())
					assert.Equal(t, "{row}/s", mi.Unit())
					assert.False(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.performance.rows_deleted":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "The number of rows deleted in the database as per the performance schema.", mi.Description())
				...
				case "mysql.performance.rows_inserted":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "The number of rows inserted in the database as per the performance schema.", mi.Description())
					assert.Equal(t, "{row}", mi.Unit())
					assert.True(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.performance.rows_read":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "The number of rows read in the database as per the performance schema.", mi.Description())
					assert.Equal(t, "{row}", mi.Unit())
					assert.True(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.performance.rows_updated":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "The number of rows updated in the database as per the performance schema.", mi.Description())
					assert.Equal(t, "{row}", mi.Unit())
					assert.True(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.query.total_errors":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "The total number of errors while performing queries in the database", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					assert.True(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.statement_event.count_stars":
					assert.False(t, validatedMetrics["mysql.statement_event.count_stars"], "Found a duplicate in the metrics slice: mysql.statement_event.count_stars")
					validatedMetrics["mysql.statement_event.count_stars"] = true
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "The total count of executed queries per normalized query and schema.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					assert.False(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.statement_event.errors":
					...
					assert.Equal(t, pmetric.MetricTypeSum, mi.Type())
					assert.Equal(t, 1, mi.Sum().DataPoints().Len())
					assert.Equal(t, "the error count of the summarized events", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					assert.True(t, mi.Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, mi.Sum().AggregationTemporality())
					dp := mi.Sum().DataPoints().At(0)
				...
				case "mysql.total_rows":
					assert.False(t, validatedMetrics["mysql.total_rows"], "Found a duplicate in the metrics slice: mysql.total_rows")
					validatedMetrics["mysql.total_rows"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total rows in the mysql db", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
