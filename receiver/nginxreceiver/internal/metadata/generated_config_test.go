		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					NginxServerZoneReceived:                  MetricConfig{Enabled: true},
					...
					NginxServerZoneSent:                      MetricConfig{Enabled: true},
					NginxUpstreamPeersBackup:                 MetricConfig{Enabled: true},
					NginxUpstreamPeersHealthChecksLastPassed: MetricConfig{Enabled: true},
					NginxUpstreamPeersReceived:               MetricConfig{Enabled: true},
					NginxUpstreamPeersRequests:               MetricConfig{Enabled: true},
					NginxUpstreamPeersResponseTime:           MetricConfig{Enabled: true},
					NginxUpstreamPeersResponses1xx:           MetricConfig{Enabled: true},
					NginxUpstreamPeersResponses2xx:           MetricConfig{Enabled: true},
					NginxUpstreamPeersResponses3xx:           MetricConfig{Enabled: true},
					NginxUpstreamPeersResponses4xx:           MetricConfig{Enabled: true},
					NginxUpstreamPeersResponses5xx:           MetricConfig{Enabled: true},
					NginxUpstreamPeersSent:                   MetricConfig{Enabled: true},
					NginxUpstreamPeersWeight:                 MetricConfig{Enabled: true},
				},
			},
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					NginxServerZoneReceived:                  MetricConfig{Enabled: false},
					...
					NginxServerZoneSent:                      MetricConfig{Enabled: false},
					NginxUpstreamPeersBackup:                 MetricConfig{Enabled: false},
					NginxUpstreamPeersHealthChecksLastPassed: MetricConfig{Enabled: false},
					NginxUpstreamPeersReceived:               MetricConfig{Enabled: false},
					NginxUpstreamPeersRequests:               MetricConfig{Enabled: false},
					NginxUpstreamPeersResponseTime:           MetricConfig{Enabled: false},
					NginxUpstreamPeersResponses1xx:           MetricConfig{Enabled: false},
					NginxUpstreamPeersResponses2xx:           MetricConfig{Enabled: false},
					NginxUpstreamPeersResponses3xx:           MetricConfig{Enabled: false},
					NginxUpstreamPeersResponses4xx:           MetricConfig{Enabled: false},
					NginxUpstreamPeersResponses5xx:           MetricConfig{Enabled: false},
					NginxUpstreamPeersSent:                   MetricConfig{Enabled: false},
					NginxUpstreamPeersWeight:                 MetricConfig{Enabled: false},
				},
			},
		},
	}
