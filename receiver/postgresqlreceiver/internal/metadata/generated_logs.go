...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, dbSystemNameAttributeValue string, dbNamespaceAttributeValue string, eventTypeAttributeValue string, dbQueryTextAttributeValue string, dbQueryTablesAttributeValue []any, userNameAttributeValue string, postgresqlStateAttributeValue string, postgresqlPidAttributeValue int64, postgresqlApplicationNameAttributeValue string, networkPeerAddressAttributeValue string, networkPeerPortAttributeValue int64, postgresqlClientHostnameAttributeValue string, postgresqlBackendTypeAttributeValue string, postgresqlXactStartAttributeValue string, postgresqlQueryStartAttributeValue string, postgresqlStateChangeAttributeValue string, postgresqlWaitEventAttributeValue string, postgresqlWaitEventTypeAttributeValue string, postgresqlBackendXidAttributeValue int64, postgresqlQueryIDAttributeValue string, postgresqlTotalExecTimeAttributeValue float64) {
	...
	dp.Attributes().PutEmptySlice("db.query.tables").FromRaw(dbQueryTablesAttributeValue)
