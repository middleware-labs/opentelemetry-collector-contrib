...
func (r *kubeletScraper) scrape(context.Context) (pmetric.Metrics, error) {
	...
	metaD := kubelet.NewMetadata(r.extraMetadataLabels, podsMetadata, nodesMetadata, nodeInfo, r.detailedPVCLabelsSetter())
...
func (r *kubeletScraper) detailedPVCLabelsSetter() func(rb *metadata.ResourceBuilder, volCacheID, volumeClaim, namespace string) ([]metadata.ResourceMetricsOption, error) {
