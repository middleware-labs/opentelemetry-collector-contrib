		...
		t.Run(tt.name, func(t *testing.T) {
			...
			for _, mi := range allMetricsList {
				...
				case "mongodb.asserts.msgps":
					...
					assert.Equal(t, "Number of message assertions raised per second.", mi.Description())
					assert.Equal(t, "{assertion}/s", mi.Unit())
				...
				case "mongodb.asserts.regularps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of regular assertions raised per second.", mi.Description())
					assert.Equal(t, "{assertion}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.asserts.rolloversps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times that the rollover counters roll over per second. The counters rollover to zero every 2^30 assertions.", mi.Description())
					assert.Equal(t, "{assertion}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.asserts.userps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of user assertions raised per second.", mi.Description())
					assert.Equal(t, "{assertion}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.asserts.warningps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of warnings raised per second.", mi.Description())
					assert.Equal(t, "{assertion}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.backgroundflushing.average_ms":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Average time for each flush to disk.", mi.Description())
				...
				case "mongodb.backgroundflushing.flushesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database has flushed all writes to disk.", mi.Description())
				...
				case "mongodb.backgroundflushing.last_ms":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time that the last flush operation took to complete.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.backgroundflushing.total_ms":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of time that the `mongod` processes have spent writing (i.e. flushing) data to disk.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.chunks.jumbo":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of 'jumbo' chunks in the mongo cluster.", mi.Description())
				...
				case "mongodb.chunks.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of chunks in the mongo cluster.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.collection.avgobjsize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The size of the average object in the collection in bytes.", mi.Description())
				...
				case "mongodb.collection.capped":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Whether or not the collection is capped. 1 if it's capped and 0 if it's not.", mi.Description())
				...
				case "mongodb.collection.indexsizes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Size of index in bytes.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					...
					assert.True(t, ok)
					assert.Equal(t, "collection-val", collectionAttrVal.Str())
					indexAttrVal, ok := dp.Attributes().Get("index")
					assert.True(t, ok)
					assert.Equal(t, "index-val", indexAttrVal.Str())
				case "mongodb.collection.max":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Maximum number of documents in a capped collection.", mi.Description())
				...
				case "mongodb.collection.maxsize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Maximum size of a capped collection in bytes.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.collection.nindexes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of indices on the collection.", mi.Description())
					assert.Equal(t, "{index}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.collection.objects":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of objects in the collection.", mi.Description())
				...
				case "mongodb.collection.size":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The total size in bytes of the data in the collection plus the size of every indexes on the mongodb.collection.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.collection.storagesize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total storage space allocated to this collection for document storage.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connection_pool.numascopedconnections":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of active and stored outgoing scoped synchronous connections from the current mongos instance to other members of the sharded cluster or replica set.", mi.Description())
				...
				case "mongodb.connection_pool.numclientconnections":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Reports the number of active and stored outgoing synchronous connections from the current mongos instance to other members of the sharded cluster or replica set.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connection_pool.totalavailable":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Reports the total number of available outgoing connections from the current mongos instance to other members of the sharded cluster or replica set.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connection_pool.totalcreatedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Reports the total number of outgoing connections created per second by the current mongos instance to other members of the sharded cluster or replica set.", mi.Description())
				...
				case "mongodb.connection_pool.totalinuse":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Reports the total number of outgoing connections from the current mongod/mongos instance to other members of the sharded cluster or replica set that are currently in use.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connection_pool.totalrefreshing":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Reports the total number of outgoing connections from the current mongos instance to other members of the sharded cluster or replica set that are currently being refreshed.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.active":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of active client connections.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.available":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of unused available incoming connections the database can provide.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.awaitingtopologychanges":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections currently waiting in a hello or isMaster request for a topology change.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.current":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of connections to the database server from clients.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.exhausthello":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections whose last request was a 'hello' request with exhaustAllowed.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.exhaustismaster":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections whose last request was an 'isMaster' request with exhaustAllowed.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.loadbalanced":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections received through the load balancer.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.rejected":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections server rejected.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.threaded":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections assigned to threads.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.connections.totalcreated":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of connections created.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.cursors.timedout":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of cursors that have timed out since the server process started.", mi.Description())
				...
				case "mongodb.cursors.totalopen":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of cursors that MongoDB is maintaining for clients", mi.Description())
					assert.Equal(t, "{cursor}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.commits":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of transactions written to the journal during the last journal group commit interval.", mi.Description())
				...
				case "mongodb.dur.commitsinwritelock":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Count of the commits that occurred while a write lock was held.", mi.Description())
				...
				case "mongodb.dur.compression":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Compression ratio of the data written to the journal.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.dur.earlycommits":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times MongoDB requested a commit before the scheduled journal group commit interval.", mi.Description())
					assert.Equal(t, "{commit}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.journaledmb":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of data written to journal during the last journal group commit interval.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.dur.timems.commits":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time spent for commits.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.timems.commitsinwritelock":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time spent for commits that occurred while a write lock was held.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.timems.dt":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time over which MongoDB collected the `dur.timeMS` data.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.timems.preplogbuffer":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time spent preparing to write to the journal.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.timems.remapprivateview":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time spent remapping copy-on-write memory mapped views.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.timems.writetodatafiles":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time spent writing to data files after journaling.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.timems.writetojournal":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of time spent writing to the journal", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.dur.writetodatafilesmb":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of data written from journal to the data files during the last journal group commit interval.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.extra_info.heap_usage_bytesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The total size in bytes of heap space used by the database process. Available on Unix/Linux systems only.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.extra_info.page_faultsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of page faults per second that require disk operations.", mi.Description())
					assert.Equal(t, "{fault}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.fsynclocked":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Metric representing the fsynclock state of a database. 1 if it's locked and 0 if it's not.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.activeclients.readers":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Count of the active client connections performing read operations.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.activeclients.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of active client connections to the database.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.activeclients.writers":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Count of active client connections performing write operations.", mi.Description())
					assert.Equal(t, "{connection}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.currentqueue.readers":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of operations that are currently queued and waiting for the read lock.", mi.Description())
				...
				case "mongodb.globallock.currentqueue.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of operations queued waiting for the lock.", mi.Description())
					assert.Equal(t, "{operation}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.currentqueue.writers":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of operations that are currently queued and waiting for the write lock.", mi.Description())
					assert.Equal(t, "{operation}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.locktime":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Time since the database last started that the globalLock has been held.", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.ratio":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Ratio of the time that the globalLock has been held to the total time since it was created.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.globallock.totaltime":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Time since the database last started and created the global lock.", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.indexcounters.accessesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times that operations have accessed indexes per second.", mi.Description())
					assert.Equal(t, "{event}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.indexcounters.hitsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second that an index has been accessed and mongod is able to return the index from memory.", mi.Description())
					assert.Equal(t, "{hit}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.indexcounters.missesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second that an operation attempted to access an index that was not in memory.", mi.Description())
					assert.Equal(t, "{miss}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.indexcounters.missratio":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Ratio of index hits to misses.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.indexcounters.resetsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second the index counters have been reset.", mi.Description())
					assert.Equal(t, "{event}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.collection.acquirecount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the collection lock type was acquired in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.locks.collection.acquirecount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the collection lock type was acquired in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.collection.acquirecount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the collection lock type was acquired in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.collection.acquirecount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the collection lock type was acquired in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.collection.acquirewaitcount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the collection lock type acquisition in the Exclusive (X) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
				...
				case "mongodb.locks.collection.acquirewaitcount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the collection lock type acquisition in the Shared (S) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.collection.timeacquiringmicros.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the collection lock type acquisitions in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.collection.timeacquiringmicros.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the collection lock type acquisitions in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirecount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type was acquired in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirecount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type was acquired in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirecount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type was acquired in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirecount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type was acquired in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirewaitcount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type acquisition in the Exclusive (X) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirewaitcount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type acquisition in the Intent Exclusive (IX) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirewaitcount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type acquisition in the Intent Shared (IS) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.acquirewaitcount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the database lock type acquisition in the Shared (S) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.timeacquiringmicros.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the database lock type acquisitions in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.timeacquiringmicros.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the database lock type acquisitions in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.timeacquiringmicros.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the database lock type acquisitions in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.database.timeacquiringmicros.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the database lock type acquisitions in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirecount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type was acquired in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirecount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type was acquired in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirecount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type was acquired in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirecount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type was acquired in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirewaitcount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type acquisition in the Exclusive (X) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirewaitcount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type acquisition in the Intent Exclusive (IX) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirewaitcount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type acquisition in the Intent Shared (IS) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.acquirewaitcount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the global lock type acquisition in the Shared (S) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.timeacquiringmicros.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the global lock type acquisitions in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.timeacquiringmicros.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the global lock type acquisitions in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.timeacquiringmicros.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the global lock type acquisitions in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.global.timeacquiringmicros.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the global lock type acquisitions in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.metadata.acquirecount.exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the metadata lock type was acquired in the Exclusive (X) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.metadata.acquirecount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the metadata lock type was acquired in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.mmapv1journal.acquirecount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the MMAPv1 storage engine lock type was acquired in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.mmapv1journal.acquirecount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the MMAPv1 storage engine lock type was acquired in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.mmapv1journal.acquirewaitcount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the MMAPv1 storage engine lock type acquisition in the Intent Exclusive (IX) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.mmapv1journal.acquirewaitcount.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the MMAPv1 storage engine lock type acquisition in the Intent Shared (IS) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.mmapv1journal.timeacquiringmicros.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the MMAPv1 storage engine lock type acquisitions in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.mmapv1journal.timeacquiringmicros.intent_sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the MMAPv1 storage engine lock type acquisitions in the Intent Shared (IS) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.oplog.acquirecount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the oplog lock type was acquired in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.oplog.acquirecount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the oplog lock type was acquired in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.oplog.acquirewaitcount.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the oplog lock type acquisition in the Intent Exclusive (IX) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.oplog.acquirewaitcount.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the oplog lock type acquisition in the Shared (S) mode encountered waits because the locks were held in a conflicting mode.", mi.Description())
					assert.Equal(t, "{wait}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.oplog.timeacquiringmicros.intent_exclusiveps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the oplog lock type acquisitions in the Intent Exclusive (IX) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.locks.oplog.timeacquiringmicros.sharedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Wait time for the oplog lock type acquisitions in the Shared (S) mode.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.mem.bits":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Size of the in-memory storage engine.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.mem.mapped":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of mapped memory by the database.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.mem.mappedwithjournal":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The amount of mapped memory, including the memory used for journaling.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.mem.resident":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of memory currently used by the database process.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.mem.virtual":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of virtual memory used by the mongod process.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.count.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times count failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.count.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times count executed", mi.Description())
				...
				case "mongodb.metrics.commands.createindexes.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times createIndexes failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.createindexes.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times createIndexes executed", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.delete.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times delete failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.delete.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times delete executed", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.eval.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times eval failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.eval.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times eval executed", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.findandmodify.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times findAndModify failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.findandmodify.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times findAndModify executed", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.insert.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times insert failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.insert.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times insert executed", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.update.failedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times update failed", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.commands.update.total":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times update executed", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.cursor.open.notimeout":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of open cursors with the option `DBQuery.Option.noTimeout` set to prevent timeout after a period of inactivity.", mi.Description())
					assert.Equal(t, "{cursor}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.cursor.open.pinned":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pinned open cursors.", mi.Description())
					assert.Equal(t, "{cursor}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.cursor.timedoutps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of cursors that time out, per second.", mi.Description())
				...
				case "mongodb.metrics.document.deletedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents deleted per second.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.metrics.document.insertedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents inserted per second.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.document.returnedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents returned by queries per second.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.document.updatedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents updated per second.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.getlasterror.wtime.numps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of getLastError operations per second with a specified write concern (i.e. w) that wait for one or more members of a replica set to acknowledge the write operation.", mi.Description())
				...
				case "mongodb.metrics.getlasterror.wtime.totalmillisps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Fraction of time (ms/s) that the mongod has spent performing getLastError operations with write concern (i.e. w) that wait for one or more members of a replica set to acknowledge the write operation.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.getlasterror.wtimeoutsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second that write concern operations have timed out as a result of the wtimeout threshold to getLastError", mi.Description())
					assert.Equal(t, "{event}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.operation.fastmodps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of update operations per second that neither cause documents to grow nor require updates to the index.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.operation.idhackps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of queries per second that contain the _id field.", mi.Description())
				...
				case "mongodb.metrics.operation.scanandorderps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of queries per second that return sorted numbers that cannot perform the sort operation using an index.", mi.Description())
					assert.Equal(t, "{query}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.operation.writeconflictsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second that write concern operations has encounter a conflict.", mi.Description())
					assert.Equal(t, "{event}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.queryexecutor.scannedobjectsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents scanned per second during queries and query-plan evaluation.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.queryexecutor.scannedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of index items scanned per second during queries and query-plan evaluation.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.record.movesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second documents move within the on-disk representation of the MongoDB data set.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.apply.batches.numps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of batches applied across all databases per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.apply.batches.totalmillisps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Fraction of time (ms/s) the mongod has spent applying operations from the oplog.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.apply.opsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of oplog operations applied per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.buffer.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of operations in the oplog buffer.", mi.Description())
					assert.Equal(t, "{operation}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.buffer.maxsizebytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Maximum size of the buffer.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.buffer.sizebytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Current size of the contents of the oplog buffer.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.network.bytesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Amount of data read from the replication sync source per second.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.network.getmores.numps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of getmore operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.network.getmores.totalmillisps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Fraction of time (ms/s) required to collect data from getmore operations.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.network.opsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of operations read from the replication source per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.network.readerscreatedps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of oplog query processes created per second.", mi.Description())
					assert.Equal(t, "{process}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.metrics.repl.preload.docs.numps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents loaded per second during the pre-fetch stage of replication.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.preload.docs.totalmillisps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Fraction of time (ms/s) spent loading documents as part of the pre-fetch stage of replication.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.repl.preload.indexes.numps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of index entries loaded by members before updating documents as part of the pre-fetch stage of replication.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.ttl.deleteddocumentsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents deleted from collections with a ttl index per second.", mi.Description())
					assert.Equal(t, "{document}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.metrics.ttl.passesps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times per second the background process removes documents from collections with a ttl index.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.network.bytesinps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The number of bytes that reflects the amount of network traffic received by this database.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.network.bytesoutps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The number of bytes that reflects the amount of network traffic sent from this database.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.network.numrequestsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of distinct requests that the server has received.", mi.Description())
				...
				case "mongodb.opcounters.commandps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of commands per second issued to the database.", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcounters.deleteps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of delete operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcounters.insertps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of insert operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcounters.queryps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of queries per second.", mi.Description())
					assert.Equal(t, "{query}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcounters.updateps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of update operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcountersrepl.commandps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of replicated commands issued to the database per second.", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcountersrepl.deleteps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of replicated delete operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcountersrepl.getmoreps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of replicated getmore operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcountersrepl.insertps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of replicated insert operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcountersrepl.queryps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of replicated queries per second.", mi.Description())
					assert.Equal(t, "{query}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.opcountersrepl.updateps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of replicated update operations per second.", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplatencies.commands.latency":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total combined latency for database commands.", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplatencies.commands.latencyps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total latency statistics for database commands per second (deprecated).", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplatencies.reads.latency":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total combined latency for read requests.", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplatencies.reads.latencyps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total latency statistics for read requests per second (deprecated).", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplatencies.writes.latency":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total combined latency for write requests.", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplatencies.writes.latencyps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total latency statistics for write operations per second (deprecated).", mi.Description())
					assert.Equal(t, "{operation}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplog.logsizemb":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total size of the oplog.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.oplog.timediff":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Oplog window: difference between the first and last operation in the oplog.", mi.Description())
				...
				case "mongodb.oplog.usedsizemb":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total amount of space used by the oplog.", mi.Description())
					assert.Equal(t, "{mebibyte}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.profiling.level":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Specifies which operations should be profiled.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.profiling.slowms":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Specifies which operations should be profiled based on slowms in milliseconds. Works only for profile level '1',", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.replset.health":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Member health value of the replica set: conveys if the member is up (i.e. 1) or down (i.e. 0).", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					...
					assert.True(t, ok)
					assert.Equal(t, "database-val", databaseAttrVal.Str())
					replicaSetAttrVal, ok := dp.Attributes().Get("replset")
					assert.True(t, ok)
					assert.Equal(t, "replica_set-val", replicaSetAttrVal.Str())
					memberNameAttrVal, ok := dp.Attributes().Get("name")
					assert.True(t, ok)
					assert.Equal(t, "member_name-val", memberNameAttrVal.Str())
					memberIDAttrVal, ok := dp.Attributes().Get("id")
					assert.True(t, ok)
					assert.Equal(t, "member_id-val", memberIDAttrVal.Str())
					memberStateAttrVal, ok := dp.Attributes().Get("state")
					assert.True(t, ok)
					assert.Equal(t, "member_state-val", memberStateAttrVal.Str())
				case "mongodb.replset.optime_lag":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Delay between a write operation on the primary and its copy to a secondary. Computed only on primary and tagged by 'member'.", mi.Description())
					assert.Equal(t, "s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.replset.replicationlag":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Delay between a write operation on the primary and its copy to a secondary. Computed on each node and tagged by 'host', but may not be representative of cluster health. Negative values do not indicate that the secondary is ahead of the primary. To use a more up-to-date metric, use mongodb.replset.optime_lag instead.", mi.Description())
					assert.Equal(t, "s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.replset.state":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "State of a replica that reflects its disposition within the set.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.replset.votefraction":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Fraction of votes a server will cast in a replica set election.", mi.Description())
					assert.Equal(t, "{fraction}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.replset.votes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The number of votes a server will cast in a replica set election.", mi.Description())
					assert.Equal(t, "{item}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.cpu_nanos":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "CPU time consumed by the operation in nanoseconds.", mi.Description())
					...
					querySignatureAttrVal, ok := dp.Attributes().Get("query_signature")
					assert.True(t, ok)
					assert.Equal(t, "query_signature-val", querySignatureAttrVal.Str())
				case "mongodb.slow_operation.docs_examined":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents examined during execution.", mi.Description())
				...
				case "mongodb.slow_operation.keys_examined":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of index keys examined during execution.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.keys_inserted":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of index keys inserted during execution.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.ndeleted":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents deleted by the operation.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.ninserted":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents inserted by the operation.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.nmatched":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents matched by the query.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.nmodified":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents modified by the operation.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.nreturned":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of documents returned by the query.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.num_yields":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of times the operation yielded control (for long-running operations).", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.planning_time_micros":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Time taken to plan the query in microseconds (only available with profiling).", mi.Description())
					assert.Equal(t, "us", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.response_length":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Length of the response returned by the operation", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.slow_operation.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The total time spent performing operations with slowms. Works only for profile level '1' & '2',", mi.Description())
					assert.Equal(t, "ms", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
					assert.Equal(t, int64(1), dp.IntValue())
					queryTimestampAttrVal, ok := dp.Attributes().Get("query_timestamp")
					assert.True(t, ok)
					assert.EqualValues(t, 15, queryTimestampAttrVal.Int())
					databaseAttrVal, ok := dp.Attributes().Get("database")
					assert.True(t, ok)
					assert.Equal(t, "database-val", databaseAttrVal.Str())
					operationAttrVal, ok := dp.Attributes().Get("operation")
					assert.True(t, ok)
					assert.Equal(t, "insert", operationAttrVal.Str())
					nsAttrVal, ok := dp.Attributes().Get("ns")
					assert.True(t, ok)
					assert.Equal(t, "ns-val", nsAttrVal.Str())
					planSummaryAttrVal, ok := dp.Attributes().Get("plan_summary")
					assert.True(t, ok)
					assert.Equal(t, "plan_summary-val", planSummaryAttrVal.Str())
					querySignatureAttrVal, ok := dp.Attributes().Get("query_signature")
					assert.True(t, ok)
					assert.Equal(t, "query_signature-val", querySignatureAttrVal.Str())
					queryIDAttrVal, ok := dp.Attributes().Get("query_id")
					assert.True(t, ok)
					assert.Equal(t, "query_id-val", queryIDAttrVal.Str())
					userAttrVal, ok := dp.Attributes().Get("user")
					assert.True(t, ok)
					assert.Equal(t, "user-val", userAttrVal.Str())
					applicationAttrVal, ok := dp.Attributes().Get("application")
					assert.True(t, ok)
					assert.Equal(t, "application-val", applicationAttrVal.Str())
					statementAttrVal, ok := dp.Attributes().Get("statement")
					assert.True(t, ok)
					assert.Equal(t, "statement-val", statementAttrVal.Str())
					rawQueryAttrVal, ok := dp.Attributes().Get("raw_query")
					assert.True(t, ok)
					assert.Equal(t, "raw_query-val", rawQueryAttrVal.Str())
					queryHashAttrVal, ok := dp.Attributes().Get("query_hash")
					assert.True(t, ok)
					assert.Equal(t, "query_hash-val", queryHashAttrVal.Str())
					queryShapeHashAttrVal, ok := dp.Attributes().Get("query_shape_hash")
					assert.True(t, ok)
					assert.Equal(t, "query_shape_hash-val", queryShapeHashAttrVal.Str())
					planCacheKeyAttrVal, ok := dp.Attributes().Get("plan_cache_key")
					assert.True(t, ok)
					assert.Equal(t, "plan_cache_key-val", planCacheKeyAttrVal.Str())
					queryFrameworkAttrVal, ok := dp.Attributes().Get("query_framework")
					assert.True(t, ok)
					assert.Equal(t, "query_framework-val", queryFrameworkAttrVal.Str())
					commentAttrVal, ok := dp.Attributes().Get("comment")
					assert.True(t, ok)
					assert.Equal(t, "comment-val", commentAttrVal.Str())
					millsAttrVal, ok := dp.Attributes().Get("mills")
					assert.True(t, ok)
					assert.EqualValues(t, 5, millsAttrVal.Int())
					numYieldsAttrVal, ok := dp.Attributes().Get("num_yields")
					assert.True(t, ok)
					assert.EqualValues(t, 10, numYieldsAttrVal.Int())
					responseLengthAttrVal, ok := dp.Attributes().Get("response_length")
					assert.True(t, ok)
					assert.EqualValues(t, 15, responseLengthAttrVal.Int())
					nreturnedAttrVal, ok := dp.Attributes().Get("nreturned")
					assert.True(t, ok)
					assert.EqualValues(t, 9, nreturnedAttrVal.Int())
					nmatchedAttrVal, ok := dp.Attributes().Get("nmatched")
					assert.True(t, ok)
					assert.EqualValues(t, 8, nmatchedAttrVal.Int())
					nmodifiedAttrVal, ok := dp.Attributes().Get("nmodified")
					assert.True(t, ok)
					assert.EqualValues(t, 9, nmodifiedAttrVal.Int())
					ninsertedAttrVal, ok := dp.Attributes().Get("ninserted")
					assert.True(t, ok)
					assert.EqualValues(t, 9, ninsertedAttrVal.Int())
					ndeletedAttrVal, ok := dp.Attributes().Get("ndeleted")
					assert.True(t, ok)
					assert.EqualValues(t, 8, ndeletedAttrVal.Int())
					keysExaminedAttrVal, ok := dp.Attributes().Get("keys_examined")
					assert.True(t, ok)
					assert.EqualValues(t, 13, keysExaminedAttrVal.Int())
					docsExaminedAttrVal, ok := dp.Attributes().Get("docs_examined")
					assert.True(t, ok)
					assert.EqualValues(t, 13, docsExaminedAttrVal.Int())
					keysInsertedAttrVal, ok := dp.Attributes().Get("keys_inserted")
					assert.True(t, ok)
					assert.EqualValues(t, 13, keysInsertedAttrVal.Int())
					writeConflictsAttrVal, ok := dp.Attributes().Get("write_conflicts")
					assert.True(t, ok)
					assert.EqualValues(t, 15, writeConflictsAttrVal.Int())
					cpuNanosAttrVal, ok := dp.Attributes().Get("cpu_nanos")
					assert.True(t, ok)
					assert.EqualValues(t, 9, cpuNanosAttrVal.Int())
					planningTimeMicrosAttrVal, ok := dp.Attributes().Get("planning_time_micros")
					assert.True(t, ok)
					assert.EqualValues(t, 20, planningTimeMicrosAttrVal.Int())
					cursorExhaustedAttrVal, ok := dp.Attributes().Get("cursor_exhausted")
					assert.True(t, ok)
					assert.True(t, cursorExhaustedAttrVal.Bool())
					upsertAttrVal, ok := dp.Attributes().Get("upsert")
					assert.True(t, ok)
					assert.True(t, upsertAttrVal.Bool())
					hasSortStageAttrVal, ok := dp.Attributes().Get("has_sort_stage")
					assert.True(t, ok)
					assert.True(t, hasSortStageAttrVal.Bool())
					usedDiskAttrVal, ok := dp.Attributes().Get("used_disk")
					assert.True(t, ok)
					assert.Equal(t, "used_disk-val", usedDiskAttrVal.Str())
					fromMultiPlannerAttrVal, ok := dp.Attributes().Get("from_multi_planner")
					assert.True(t, ok)
					assert.Equal(t, "from_multi_planner-val", fromMultiPlannerAttrVal.Str())
					replannedAttrVal, ok := dp.Attributes().Get("replanned")
					assert.True(t, ok)
					assert.Equal(t, "replanned-val", replannedAttrVal.Str())
					replanReasonAttrVal, ok := dp.Attributes().Get("replan_reason")
					assert.True(t, ok)
					assert.Equal(t, "replan_reason-val", replanReasonAttrVal.Str())
					clientAttrVal, ok := dp.Attributes().Get("client")
					assert.True(t, ok)
					assert.Equal(t, "client-val", clientAttrVal.Str())
					cursorAttrVal, ok := dp.Attributes().Get("cursor")
					assert.True(t, ok)
					assert.Equal(t, "cursor-val", cursorAttrVal.Str())
					lockStatsAttrVal, ok := dp.Attributes().Get("lock_stats")
					assert.True(t, ok)
					assert.Equal(t, "lock_stats-val", lockStatsAttrVal.Str())
					flowControlStatsAttrVal, ok := dp.Attributes().Get("flow_control_stats")
					assert.True(t, ok)
					assert.Equal(t, "flow_control_stats-val", flowControlStatsAttrVal.Str())
				case "mongodb.slow_operation.write_conflicts":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of write conflicts encountered during execution.", mi.Description())
					assert.Empty(t, mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.avgobjsize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "The average size of each document in bytes.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.collections":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Contains a count of the number of collections in that database.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.datasize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total size of the data held in this database including the padding factor.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.filesize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total size of the data held in this database including the padding factor (only available with the mmapv1 storage engine).", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.indexes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of indexes across all collections in the database.", mi.Description())
					assert.Equal(t, "{index}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.indexsize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total size of all indexes created on this database.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.numextents":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Contains a count of the number of extents in the database across all collections.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.stats.objects":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of objects (documents) in the database across all collections.", mi.Description())
				...
				case "mongodb.stats.storagesize":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total amount of space allocated to collections in this database for document storage.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.generic.current_allocated_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of bytes used by the application.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.generic.heap_size":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Bytes of system memory reserved by TCMalloc.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.aggressive_memory_decommit":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Status of aggressive memory decommit mode.", mi.Description())
					assert.Equal(t, "1", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.central_cache_free_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of free bytes in the central cache.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.current_total_thread_cache_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of bytes used across all thread caches.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.max_total_thread_cache_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Upper limit on total number of bytes stored across all per-thread caches.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.pageheap_free_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of bytes in free mapped pages in page heap.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.pageheap_unmapped_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of bytes in free unmapped pages in page heap.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.spinlock_total_delay_ns":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Spinlock delay time.", mi.Description())
					assert.Equal(t, "ns", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.thread_cache_free_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of free bytes in thread caches.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.tcmalloc.tcmalloc.transfer_cache_free_bytes":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of free bytes that are waiting to be transferred between the central cache and a thread cache.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.commands.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of commands since server start (deprecated)", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.commands.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of commands per second", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.commands.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing commands in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.getmore.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of getmore since server start (deprecated)", mi.Description())
					assert.Equal(t, "{fetch}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.usage.getmore.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of getmore per second", mi.Description())
					assert.Equal(t, "{fetch}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.usage.getmore.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing getmore in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.insert.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of inserts since server start (deprecated)", mi.Description())
					assert.Equal(t, "{commit}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.insert.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of inserts per second", mi.Description())
					assert.Equal(t, "{commit}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.usage.insert.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing inserts in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.queries.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of queries since server start (deprecated)", mi.Description())
				...
				case "mongodb.usage.queries.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of queries per second", mi.Description())
					assert.Equal(t, "{query}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.queries.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing queries in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.readlock.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of read locks since server start (deprecated)", mi.Description())
				...
				case "mongodb.usage.readlock.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of read locks per second", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.readlock.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing read locks in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.remove.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of removes since server start (deprecated)", mi.Description())
					assert.Equal(t, "{commit}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.remove.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of removes per second", mi.Description())
					assert.Equal(t, "{commit}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.remove.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing removes in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.total.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of operations since server start (deprecated)", mi.Description())
					assert.Equal(t, "{command}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.total.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of operations per second", mi.Description())
					assert.Equal(t, "{command}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.total.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent holding locks in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.update.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of updates since server start (deprecated)", mi.Description())
					assert.Equal(t, "{commit}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.update.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of updates per second", mi.Description())
					assert.Equal(t, "{commit}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.update.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing updates in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.writelock.count":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of write locks since server start (deprecated)", mi.Description())
					assert.Equal(t, "{lock}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.writelock.countps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of write locks per second", mi.Description())
					assert.Equal(t, "{lock}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.usage.writelock.time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total time spent performing write locks in microseconds", mi.Description())
					assert.Equal(t, "{microsecond}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.bytes_currently_in_cache":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Size of the data currently in cache.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.failed_eviction_of_pages_exceeding_the_in_memory_maximumps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of failed eviction of pages that exceeded the in-memory maximum, per second.", mi.Description())
				...
				case "mongodb.wiredtiger.cache.in_memory_page_splits":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "In-memory page splits.", mi.Description())
					assert.Equal(t, "{split}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
				...
				case "mongodb.wiredtiger.cache.maximum_bytes_configured":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Maximum cache size.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.maximum_page_size_at_eviction":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Maximum page size at eviction.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.modified_pages_evicted":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pages, that have been modified, evicted from the cache.", mi.Description())
				...
				case "mongodb.wiredtiger.cache.pages_currently_held_in_cache":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pages currently held in the cache.", mi.Description())
					assert.Equal(t, "{page}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.pages_evicted_by_application_threadsps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of page evicted by application threads per second.", mi.Description())
					assert.Equal(t, "{page}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.pages_evicted_exceeding_the_in_memory_maximumps":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pages evicted because they exceeded the cache in-memory maximum, per second.", mi.Description())
					assert.Equal(t, "{page}/s", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.pages_read_into_cache":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pages read into the cache.", mi.Description())
					assert.Equal(t, "{page}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.pages_written_from_cache":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pages writtent from the cache", mi.Description())
					assert.Equal(t, "{page}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.tracked_dirty_bytes_in_cache":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Size of the dirty data in the cache.", mi.Description())
					assert.Equal(t, "By", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.cache.unmodified_pages_evicted":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of pages, that were not modified, evicted from the cache.", mi.Description())
					assert.Equal(t, "{page}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.concurrenttransactions.read.available":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of available read tickets (concurrent transactions) remaining.", mi.Description())
				...
				case "mongodb.wiredtiger.concurrenttransactions.read.out":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of read tickets (concurrent transactions) in use.", mi.Description())
					assert.Equal(t, "{ticket}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.concurrenttransactions.read.totaltickets":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of read tickets (concurrent transactions) available.", mi.Description())
					assert.Equal(t, "{ticket}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.concurrenttransactions.write.available":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of available write tickets (concurrent transactions) remaining.", mi.Description())
					assert.Equal(t, "{ticket}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.concurrenttransactions.write.out":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Number of write tickets (concurrent transactions) in use.", mi.Description())
					assert.Equal(t, "{ticket}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
				...
				case "mongodb.wiredtiger.concurrenttransactions.write.totaltickets":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, mi.Type())
					assert.Equal(t, 1, mi.Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of write tickets (concurrent transactions) available.", mi.Description())
					assert.Equal(t, "{ticket}", mi.Unit())
					dp := mi.Gauge().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
					assert.Equal(t, ts, dp.Timestamp())
