...
// MetricsConfig provides config for mwmongodb metrics.
...
// ResourceAttributesConfig provides config for mwmongodb resource attributes.
...
// MetricsBuilderConfig is a configuration for mwmongodb metrics builder.
